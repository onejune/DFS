...
{
    //生物种质资源：4-11 生物种质资源保存机构人才培养情况2
    class ResearchInstitution4_11_2 : AbstractTable
    {
        public ResearchInstitution4_11_2()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "4-11  生物种质资源保存机构人才培养情况2";
            dataCompile.TableName = SharedData.tableListInDB[7].ViewName;
            dataCompile.UnitName = "人";
            dataCompile.SelectedColumnListA.Add("博士研究生入学（进站）人数");
            dataCompile.SelectedColumnListA.Add("博士研究生毕业（出站）人数");
            dataCompile.SelectedColumnListA.Add("博士研究生（在站）人数");

            dataCompile.SummaryColumnNameA = "博士研究生人数";
            ...
            //用于检查列名
            columnCheckList.Add("博士研究生（在站）人数");
            columnCheckList.Add("博士研究生入学（进站）人数");
            columnCheckList.Add("博士研究生毕业（出站）人数");
            columnCheckList.Add("博士研究生人数");
        }
    }
}
