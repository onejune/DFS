...
{
    //生物种质资源：4-4 动物种质资源保存机构级别情况
    class ResearchInstitution4_4 : AbstractTable
    {
        public ResearchInstitution4_4()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "4-4  动物种质资源保存机构级别情况";
            dataCompile.TableName = SharedData.tableListInDB[5].ViewName;
            dataCompile.UnitName = "个";
            dataCompile.SelectedColumnListA.Add("设施级别");
            dataCompile.SummaryColumnNameA = "动物种质资源";
