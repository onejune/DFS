...
{
    //生物种质资源：4-1 生物种质资源保存机构数
    class ResearchInstitution4_1 : AbstractTable
    {
        public ResearchInstitution4_1()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "4-1  生物种质资源保存机构数";
            dataCompile.TableName = SharedData.tableListInDB[5].ViewName;
            dataCompile.UnitName = "个";
            dataCompile.SelectedColumnListA.Add("资源领域");
