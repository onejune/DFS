...
{
    //生物种质资源：4-23 微生物种质资源保藏类型
    class ResearchInstitution4_23 : AbstractTable
    {
        public ResearchInstitution4_23()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "4-23 微生物种质资源保藏类型";
            dataCompile.TableName = SharedData.tableListInDB[9].ViewName;
            dataCompile.UnitName = "株";
            dataCompile.SelectedColumnListA.Add("保藏类型");
