...
{
    //研究实验基地：3-1 研究实验基地数3
    class ResearchInstitution3_1_3 : AbstractTable
    {
        public ResearchInstitution3_1_3()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "3-1  研究实验基地数3";
            ...
            {
                if (baseBigType[i].IndexOf("研究中心") != -1)
                {
            ...
            {
                HasError = true;
                Log.RecordLog(dataCompile.Caption + ": " + dataCompile.TableName + ": 找不到\"工程（技术）研究中心\"列！");
                return;
            }
