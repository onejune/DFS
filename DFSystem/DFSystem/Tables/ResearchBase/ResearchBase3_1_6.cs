...
{
    //研究实验基地：3-1 研究实验基地数6
    class ResearchInstitution3_1_6 : AbstractTable
    {
        public ResearchInstitution3_1_6()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "3-1  研究实验基地数6";
            ...
            {
                if ((baseBigType[i].IndexOf("国家重大科学工程") != -1) )
                {
            ...
            dataCompile.SelectedColumnListB.Add("全国汇编用基地小类");
