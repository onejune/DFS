...
{
    //研究实验基地：3-1 研究实验基地数2
    class ResearchInstitution3_1_2 : AbstractTable
    {
        public ResearchInstitution3_1_2()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "3-1  研究实验基地数2";
            ...
            {
                HasError = true;
                Log.RecordLog(dataCompile.Caption + ": " + dataCompile.TableName + ": 找不到\"野外台站\"列！");
                return;
            }
