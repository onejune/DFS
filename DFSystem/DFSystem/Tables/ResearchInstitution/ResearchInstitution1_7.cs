...
{
    //科研院所和高校概况：1-7 科研院所和高校科技活动人员概况
    class ResearchInstitution1_7 : AbstractTable
    {
        public ResearchInstitution1_7()
        {
            tableCaption = "1-7 科研院所和高校科技活动人员概况";
            dataTableName = SharedData.tableListInDB[2].ViewName;
            unitName = "人";

            //用于检查列名
            columnCheckList.Add("男性");
            columnCheckList.Add("女性");
            columnCheckList.Add("科教人员");
            columnCheckList.Add("科研管理人员");
            columnCheckList.Add("科研辅助人员");
            columnCheckList.Add("科技活动人员总数");

            //实际显示的列名
            finalListA.Add("男性");
            finalListA.Add("女性");
            finalListA.Add("科教人员");
            finalListA.Add("科研管理人员");
            finalListA.Add("科研辅助人员");
        }
        ...
        public override bool GenerateSQL()
        {
            ...
            sqlStrForCompile = "select 所在省, convert(bigint, sum(cast(\"男性\" as float)))  as \"男性\", convert(bigint, sum(cast(\"女性\" as float)))  as \"女性\", convert(bigint, sum(cast(\"科教人员\" as float)))  as \"科教人员\", convert(bigint, sum(cast(\"科研管理人员\" as float)))  as \"科研管理人员\", convert(bigint, sum(cast(\"科研辅助人员\" as float)))  as \"科研辅助人员\", (convert(bigint, sum(cast(\"科技活动人员总数\" as float)))) as '科技活动人员'  FROM ["
        ...
        public override void FillTable(List<Table> table)
        {
            ...
            newTable.Cell(1, 2).Range.Text = "科技活动人员";
            ...
            while (reader.Read())
            {
                ...
                //第二列，汇总列
                string value = reader["科技活动人员"].ToString().Trim();
                if (value.IndexOf('.') != -1)
                {
