...
{
    //科研院所和高校概况：1-8 科研院所和高校科技活动人员学历结构
    class ResearchInstitution1_8 : AbstractTable
    {
        public ResearchInstitution1_8()
        {
            tableCaption = "1-8 科研院所和高校科技活动人员学历结构";
            dataTableName = SharedData.tableListInDB[2].ViewName;
            unitName = "人";

            //用于检查列名
            columnCheckList.Add("硕士研究生");
            columnCheckList.Add("博士研究生");
            columnCheckList.Add("大学");
            columnCheckList.Add("其他（学历）");
            columnCheckList.Add("科技活动人员总数");
            columnCheckList.Add("所在省");

            //实际显示的列名，名称和sql语句中列的别名一致
            finalListA.Add("博士研究生");
            finalListA.Add("硕士研究生");
            finalListA.Add("大本");
            finalListA.Add("其他");
        }
        ...
        public override bool GenerateSQL()
        {
            ...
            sqlStrForCompile = "select 所在省, convert(bigint, sum(cast(\"硕士研究生\" as float)))  as \"硕士研究生\", convert(bigint, sum(cast(\"博士研究生\" as float)))  as \"博士研究生\", convert(bigint, sum(cast(\"大学\" as float)))  as \"大本\", convert(bigint, sum(cast(\"其他（学历）\" as float)))  as \"其他\", ( convert(bigint, sum(cast(\"科技活动人员总数\" as float)))) as '科技活动人员'  FROM ["
