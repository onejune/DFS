...
{
    //科研院所和高校概况：1-9 科研院所和高校科技活动人员职称结构
    class ResearchInstitution1_9 : AbstractTable
    {
        public ResearchInstitution1_9()
        {
            tableCaption = "1-9 科研院所和高校科技活动人员职称结构";
            ...
            columnCheckList.Add("中级");
            columnCheckList.Add("其他（职称）");
        ...
        public override bool GenerateSQL()
        {
            ...
            sqlStrForCompile = "select 所在省, convert(bigint, sum(cast(\"正高级\" as float)))  as \"正高级\", convert(bigint, sum(cast(\"副高级\" as float)))  as \"副高级\", convert(bigint, sum(cast(\"中级\" as float)))  as \"中级\", convert(bigint, sum(cast(\"其他（职称）\" as float)))  as \"其他\", ( convert(bigint, sum(cast(\"科技活动人员总数\" as float)))) as '科技活动人员' FROM ["
