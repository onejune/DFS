...
{
    //科研院所和高校概况：2-8 按获取方式分类的大型科学仪器设备原值2
    class ResearchInstitution2_8_2 : AbstractTable
    {
        public ResearchInstitution2_8_2()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "2-8 按获取方式分类的大型科学仪器设备原值2";
