...
{
    //科研院所和高校概况：2-2 按单台原值分段的大型科学仪器设备原值2
    class ResearchInstitution2_2_2 : AbstractTable
    {
        public ResearchInstitution2_2_2()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "2-2 按单台原值分段的大型科学仪器设备原值2";
