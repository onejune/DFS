...
{
    //科研院所和高校概况：2-4 按购置年代分段的大型科学仪器设备原值1
    class ResearchInstitution2_4_1 : AbstractTable
    {
        public ResearchInstitution2_4_1()
        {
            dataCompile = new DataCompile();
            dataCompile.Caption = "2-4 按购置年代分段的大型科学仪器设备原值1";
